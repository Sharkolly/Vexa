      ...
      <div className="grid xl:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg max-md:shadow-xl max-md:border max-md:border-gray-200 h-fit sticky top-4  overflow-y-auto mb-10">
          ...
          {deliveryFee > 0 && <Link to="/checkout">
            ...
            <button disabled={calculating} className="w-full outline-none py-3 mb-4 mt-6 bg-green-800/90 text-white  rounded-xl shadow-lg hover:-translate-y-0.5 transition-all duration-300 active:scale-[0.98] cursor-pointer flex items-center justify-center  gap-2" onClick={calcDistance}>
              <span>
                <IoBagCheckOutline className="text-white w-5 h-5" />
              </span>
