...
const DeliveryPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-28 pb-10 max-md:pt-24">
      ...
      <div className="bg-white md:p-6 rounded-xl shadow-lg h-fit sticky top-4 p-3 py-5  max-md:shadow-none overflow-y-auto">
