    ...
    <div className="basis-[55%] max-md:mb-10  relative ">
      <div className="w-full h-fit ">
        <div className="flex items-center gap-3 ">
          ...
          <div className="rounded-md w-full h-full  overflow-hidden border cursor-pointer hover:border-primary  transition-all">
            ...
            //   </div>
              ...
              <img
                className="w-full h-160 max-md:h-90 object-center  object-cover"
