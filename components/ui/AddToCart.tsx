...
const AddToCart = ({
  ...
  return (
    <button
      ...
      className={
        AddToCartClassName ||
        "w-full min-[500px]:w-[55%] lg:w-[85%] bg-emerald-700 hover:bg-emerald-800 text-white font-semibold py-2.5 px-4 rounded-xl text-xs uppercase tracking-wider transition-all shadow-sm active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer"
      }
